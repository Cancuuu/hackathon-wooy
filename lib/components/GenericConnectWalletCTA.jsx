...
import { Button, Tooltip } from '@wooy/react-components'
  ...
  return (
    <>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center mt-8'>
        ...
        >
          <div className='flex items-center opacity-60 font-bold text-accent-3 text-xxs'>
        ...
        <div className='opacity-60 font-bold sm:ml-8 mt-1 sm:mt-0'>
          <a
            ...
            target='_blank'
            className='text-accent-3 text-xxs flex items-center'
          >
