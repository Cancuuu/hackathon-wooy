...
import { Button, PrizeFrequencyChip, TokenIcon } from '@wooy/react-components'
    ...
    >
      ...
      <PoolRowContents>
        <PoolRowContentSide className='py-2 p-4 lg:px-6 sm:pt-3 sm:pb-5 justify-center sm:justify-start'>
          {!!poolSettings?.iconUrl && (
            <div className='flex flex-col mx-auto'>
              <div className='flex items-center justify-center'></div>
                <img src={poolSettings.iconUrl} width="100" height="100" className='mr-2 my-auto'/>
            </div>
          )}
