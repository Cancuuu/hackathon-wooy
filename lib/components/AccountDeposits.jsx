...
import { useIsTestnets, useUserTicketsFormattedByPool } from '@wooy/hooks'
import { useOnboard } from '@wooy/bnc-onboard-hooks'
import { Card, ExternalLink } from '@wooy/react-components'
...
const NoTicketsState = (props) => {
  ...
  if (poolTickets.length === 0 && podTickets.length === 0 && noV2Tickets) {
    return (
      <Card className='text-center bg-accent-grey-4'>
